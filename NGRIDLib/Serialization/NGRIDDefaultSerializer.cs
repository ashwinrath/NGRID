...
{
    /// <summary>
    /// This class is the default serializer of NGRID.
    /// The serialized object must be deserialized by NGRIDDefaultDeserializer.
    /// Only needed serializers designed for NGRID.
    /// </summary>
    public class NGRIDDefaultSerializer : INGRIDSerializer
    {
        ...
        /// <summary>
        /// Creates a new NGRIDDefaultSerializer object.
        /// </summary>
        /// <param name="stream">The stream that is used to write serialized items</param>
        public NGRIDDefaultSerializer(Stream stream)
        {
            _stream = stream;
        }
