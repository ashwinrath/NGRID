...
{
    /// <summary>
    /// This class is the default deserializer of NGRID.
    /// The deserializing object must be serialized by NGRIDDefaultSerializer.
    /// Only needed deserializers designed for NGRID.
    /// </summary>
    public class NGRIDDefaultDeserializer : INGRIDDeserializer
    {
        ...
        /// <summary>
        /// Creates a new NGRIDDefaultDeserializer object.
        /// </summary>
        /// <param name="stream">The stream that is used to read serialized items for deserializing</param>
        public NGRIDDefaultDeserializer(Stream stream)
        {
            _stream = stream;
        }
        ...
        {
            throw new NGRIDSerializationException("Can not read from stream! Input stream is closed.");
        }
