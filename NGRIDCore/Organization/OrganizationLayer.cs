...
{
    /// <summary>
    /// This class represents organization layer of NGRID Server. It handles, stores, routes and delivers messages.
    /// </summary>
    public class OrganizationLayer : IRunnable
    {
        ...
        /// <summary>
        /// Reference to all NGRID Manager. It contains communicators to all instances of NGRID manager.
        /// So, there is only one NGRIDController object in NGRID.
        /// </summary>
        ...
        public NGRIDClientApplication[] GetClientApplications()
        {
        ...
        {
            //Add NGRID servers to communication layer, set needed objects and register events
            ...
            _ngridManager.Settings = _settings;
            _communicationLayer.AddRemoteApplication(_ngridManager);
        }
        ...
        #region Incoming message handling from NGRID Serves / Client Applications
        ...
        #region Processing NGRIDDataTransferMessage message
        ...
        private void AddThisServerToPassedServerList(NGRIDDataTransferMessage message)
        {
        ...
        private class WaitingMessage
        {
            ...
            /// </summary>
            public NGRIDOperationResultMessage ResponseMessage { get; set; }
