...
namespace NGRID.Communication
{
    ...
    public abstract class CommunicatorBase : ICommunicator
    {
        ...
        public void Start()
        {
            ...
            {
                throw new NGRIDException("Communicator is already connected");
            }
        ...
        /// <summary>
        /// When a NGRIDMessage received, this method is called from derived class.
        /// </summary>
        /// <param name="message">incoming message from communicator</param>
        protected void OnMessageReceived(NGRIDMessage message)
        {
        ...
        /// </summary>
        protected abstract void SendMessageInternal(NGRIDMessage message);
