...
namespace NGRID.Communication.TCPCommunication
{
    ...
    public class TCPCommunicator : CommunicatorBase
    {
        ...
        protected override void StartCommunicaiton()
        {
            ...
            {
                throw new NGRIDException("Tried to start communication with a TCP socket that is not connected.");
            }
        ...
        protected override void SendMessageInternal(NGRIDMessage message)
        {
            ...
            {
                throw new NGRIDException("Communicator's state is not connected. It can not send message.");
            }
        ...
        private void DoCommunicateAsThread()
        {
            ...
            while (State == CommunicationStates.Connected || State == CommunicationStates.Connecting)
            {
                try
                {
                    ...
                    var message = _wireProtocol.ReadMessage(new NGRIDDefaultDeserializer(_networkStream));
