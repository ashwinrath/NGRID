...
{
    /// <summary>
    /// This file contains subclasses of NGRIDRemoteApplication.
    /// It is created to reduce complexity of NGRIDRemoteApplication class.
    /// </summary>
    public abstract partial class NGRIDRemoteApplication
    {
        #region MessageDeliverer class
        
        /// <summary>
        /// This class is used to deliver messages to remote application.
        /// It is designed to seperate message sending/delivering process from other processes of NGRIDRemoteApplication class.
        /// </summary>
        private class MessageDeliverer :IRunnable
        {
            ...
            /// <summary>
            /// Reference to the NGRIDRemoteApplication object that is used with this MessageDeliverer.
            /// </summary>
            private readonly NGRIDRemoteApplication _remoteApplication;
            ...
            /// <summary>
            /// This method is used to send a NGRIDDataTransferMessage to an available communicator of application.
            ...
            public void SendDataMessage(NGRIDDataTransferMessage message, int timeOut)
            {
                ...
                lock (_remoteApplication._communicators)
                {
                    ...
                    while (receiver == null)
                    {
                        ...
                        {
                            throw new NGRIDNoCommunicatorException("There is no communicator for remote application '" + _remoteApplication.Name + "' to send message.");
                        }
                        ...
                        {
                            throw new NGRIDTimeoutException("All communicators for remote application '" + _remoteApplication.Name + "' are busy. Waited for " + timeOut + " ms.");
                        }
            ...
            /// <summary>
            /// Sends a NGRIDMessage to a spesific communicator of this application.
            ...
            public void SendMessage(NGRIDMessage message, ICommunicator communicator)
            {
            ...
            /// <summary>
            /// This method is used to get NGRIDOperationResultMessage objects (ACK/Reject messages) by MessageDeliverer class.
            /// It is called by NGRIDRemoteApplication's Communicator_MessageReceived method.
            /// </summary>
                    ...
                    lock (_remoteApplication._communicators)
                    {
                        ...
                        foreach (var connectedCommunicator in _remoteApplication._communicators)
                        {
                            ...
                            _remoteApplication.OnResponseReceived(
                                null, new NGRIDOperationResultMessage
                                          {
            ...
            private ConnectedCommunicator GetFreeReceiverCommunicator(long communicatorId)
            {
                ...
                if (!communicatorExists)
                {
                    if (communicatorId > 0)
                    {
                        throw new NGRIDNoCommunicatorException("There is no communicator for remote application '" +
            ...
            private static void SetLeavingTime(NGRIDDataTransferMessage message)
            {
        ...
        protected class ConnectedCommunicator
        {
            ...
            /// </summary>
            public NGRIDDataTransferMessage ProcessingMessage { get; set; }
